    ...
    'node_modules/js-yaml/lib/snippet.js'(exports, module) {
        ...
        function makeSnippet(mark, options) {
            ...
            for (i = 1; i <= options.linesAfter; i++) {
                ...
                result +=
                    common.repeat(' ', options.indent) + padStart((mark.line + i + 1).toString(), lineNoLength) + ' | ' + line.str + '\n';
            }
    ...
    'node_modules/js-yaml/lib/dumper.js'(exports, module) {
        ...
        function chooseScalarStyle(
            ...
            if (singleLineOnly || forceQuotes) {
                ...
                hasFoldableLine =
                    hasFoldableLine || (shouldTrackWidth && i - previousLineBreak - 1 > lineWidth && string[previousLineBreak + 1] !== ' ');
            }
        ...
        function writeScalar(state, string, level, iskey, inblock) {
            state.dump = (function () {
                ...
                switch (
                    ...
                    case STYLE_FOLDED:
                        return (
                            '>' + blockHeader(string, state.indent) + dropEndingNewline(indentString(foldString(string, lineWidth), indent))
                        );
                    case STYLE_DOUBLE:
